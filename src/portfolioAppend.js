...
export default (length, videoLength) => {
  ...
  Object.keys(modules).slice(0, length).forEach(async (key) => {
    ...
    const type = key.split('_')[1]?.replace('.jpg', '') || 'nature';
    const c = $(`<div class="col-12 col-sm-6 col-lg-3 single_gallery_item ${type} mb-30 wow fadeInUp" data-wow-delay="100ms">
